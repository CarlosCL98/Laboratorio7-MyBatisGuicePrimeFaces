...
public class ServiciosAlquilerItemsStub implements ServiciosAlquiler {
   ...
   @Override
   public int valorTarifaAlquilerxDia(int itemId) {return 0;}
   ...
   public long consultarMultaAlquiler(int iditem, Date fechaDevolucion) throws ExcepcionServiciosAlquiler{
       if (!itemsrentados.containsKey(iditem)){
           ...
           LocalDate fechaMinimaEntrega=((java.sql.Date) ir.getFechafinrenta()).toLocalDate();
           LocalDate fechaEntrega=((java.sql.Date) fechaDevolucion).toLocalDate();
